# Spring 2026 ECE 408 / CS 483 / CSE 408 Course Files
...
For those opting to connect with VSCode Remote - SSH extension, setup instructions to connect to Delta are available at this link: https://docs.ncsa.illinois.edu/systems/delta/en/latest/user_guide/prog_env.html#visual-studio-code.
...
First, follow this link to establish a class repository: https://edu.cs.illinois.edu/create-gh-repo/sp26_ece408. This needs to be done only once. After this step is complete, you should be able to visit https://github.com/illinois-cs-coursework/sp26_ece408_NETID page (where NETID is your UIUC NetID) that shows the contents of your repository. Initially, this repository will be empty; it will be populated soon.
...
In a Delta terminal, navigate to the location where you would like to keep your files for ECE 408, most likelly in your home directory. Run the following to clone your repository:
  ...
  `git clone https://github.com/illinois-cs-coursework/sp26_ece408_NETID.git ece408git` where NETID is your UIUC NetID.
...
And finally add release repository so you can receive class assignments: 
  ...
  `git remote add release https://github.com/illinois-cs-coursework/sp26_ece408_.release.git`
